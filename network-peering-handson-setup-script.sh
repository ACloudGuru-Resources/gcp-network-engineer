...
echo Create firewall rules to allow port 22 access for all network resources
...
echo Create instance in each legitimate subnet
...
echo ----------------------------------
echo Setup complete, proceed with hands on demo
echo ----------------------------------
